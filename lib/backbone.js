...
(function() {
  ...
  _.extend(Model.prototype, Events, {
    ...
    url : function() {
      var base = getValue(this, 'urlRoot') ||
                 getValue(this.collection, 'url') || urlError();
      if (this.isNew())
        return base;
  ...
  var methods = [
    'forEach',     'each',    'map',     'reduce',  'reduceRight',
    'find',        'detect',  'filter',  'select',  'reject',
    'every',       'all',     'some',    'any',     'include',
    'contains',    'invoke',  'max',     'min',     'sortBy',
    'sortedIndex', 'toArray', 'size',    'first',   'initial',
    'rest',        'last',    'without', 'indexOf', 'shuffle',
  ...
  _.extend(History.prototype, Events, {
    ...
    start : function(options) {
      ...
      if (this._wantsHashChange && this._wantsPushState &&
        ...
        this.location.replace(this.options.root + this.location.search + '#' +
                              this.fragment);
    ...
    navigate : function(fragment, options) {
      ...
      this.fragment = frag;
      var url =
          (frag.indexOf(this.options.root) != 0 ? this.options.root : '') +
          frag;
    ...
    _updateHash : function(location, fragment, replace) {
      if (replace) {
        location.replace(location.href.replace(/(javascript:|#).*$/, '') + '#' +
                         fragment);
      } else {
