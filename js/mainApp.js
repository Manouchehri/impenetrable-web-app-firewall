...
url:"/data/getSubMenu.asp",
postUrl:"/goform/SubMenu"
});
...
var BatteryModel = Backbone.Model.extend({
urlRoot:"data/battery.asp"
});
...
$('#brand-menu').html('<img src="img/logo_gci_small.png" alt="GCI" height="32px"></img>');
...
$('#brand-menu').html('<img src="/img/logo_access.png" alt="ACCESS" height="32px"></img>');
$('.htx_slim_devider').hide();
$('.icon-user').removeClass('icon-white');
}
});
this.$('#currentUser').load('data/getUser.asp?_=' + Math.random(),function(){
...
{
//console.log(getCookieValue("isEdit")+"  "+getCookieValue("isEdit1")+"   "+getCookieValue("isEdit2"));
